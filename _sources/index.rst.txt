...
For the annealing solvers, there are different implementations based on the `Fixstars Amplify SDK <https://amplify.fixstars.com/en/sdk>`_, the `D-Wave Ocean SDK <https://www.dwavesys.com/solutions-and-products/ocean/>`_, or `OpenJij <https://www.openjij.org>`_.
